...
import com.backbase.movies.controller.MovieController;
...
class MovieControllerTest {
    ...
    void rateMovie() throws Exception {
        ...
        mockMvc.perform(
                MockMvcRequestBuilders.post("/" + Constants.REQUEST_MAPPING + Constants.RATE)
    ...
    void isMovieWonOscar() throws Exception {
        ...
        mockMvc.perform(
                MockMvcRequestBuilders.get("/" + Constants.REQUEST_MAPPING + Constants.AWARD)
                        .param("title", "Oz")
                        .contentType(MediaType.APPLICATION_JSON)
                        .accept(MediaType.APPLICATION_JSON)
        )
    ...
    void getTopRatedMovies() throws Exception {
        ...
        mockMvc.perform(
                MockMvcRequestBuilders.get("/" + Constants.REQUEST_MAPPING + Constants.TOP_RATED)
                        .contentType(MediaType.APPLICATION_JSON)
                        .accept(MediaType.APPLICATION_JSON)
        )
                .andExpect(status().isOk())
