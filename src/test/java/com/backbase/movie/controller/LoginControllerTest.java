...
import com.backbase.movies.controller.LoginController;
import com.backbase.movies.dto.request.WebUserDto;
import com.backbase.movies.exception.LoginSessionExpiredException;
...
class LoginControllerTest {
    ...
    void signin() throws Exception {
        ...
        mockMvc.perform(
                MockMvcRequestBuilders.post("/" + Constants.LOGIN)
